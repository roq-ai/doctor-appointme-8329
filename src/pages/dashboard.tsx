...
import { useHealthcareProviderCount, usePatientCount, useInsuranceProviderCount } from 'lib/roq';

import { PatientListPage as ShowCaseList } from 'pages/patients';

function DashboardPage() {
  const { session } = useSession();

  const healthcareProviderStat = useHealthcareProviderCount();

  const patientStat = usePatientCount();
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`patients`} passHref legacyBehavior>
                  <Button
