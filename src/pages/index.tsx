  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Doctor Appointment System - Streamlining healthcare, connecting patients and physicians, and simplifying the appointment booking process for a seamless medical experience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkb2N0b3J8ZW58MHx8fHwxNjk3NDYzNDExfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Doctor Appointment System - Streamlining healthcare, connecting patients and physicians, and simplifying the appointment booking process for a seamless medical experience.`}
            </Text>
            <Box
