...
function AppointmentViewPage() {
  ...
  const queryParams = useMemo<{ include: { patient: boolean; healthcare_provider: boolean; clinic: boolean } }>(
    () =>
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Appointment Time" text={data?.appointment_time} />

                <FormListItem label="Reason For Visit" text={data?.reason_for_visit} />
                ...
                {hasAccess('healthcare_provider', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/healthcare-providers/view/${data?.healthcare_provider?.id}`}>
                        {data?.healthcare_provider?.specialization + ''}
                      </Link>
                    }
                  />
                )}
